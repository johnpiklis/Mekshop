      ...
      <div className="container">
        ...
        >
          <div className="p-6 sm:p-8">
            ...
            <h1
              data-aos="zoom-out"
              className="uppercase text-4xl lg:7xl font-bold"
            >
              {data.title}
            </h1>
          ...
          <div data-aos="zoom-in" className="h-full flex items-center">
            <img
              src={data.image}
              alt=""
              className="scale-125 width-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover"
            />
          </div>
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <div data-aos="fade-up" data-aos-offset="0">
              <button
                ...
                className="bg-white px-4 py-2 rounded-full text-sm hover:scale-105 duration-300"
              >
                Shop Now
              </button>
            </div>
